...
$SQL145 = "SELECT * FROM `registration` WHERE `unique_id`='$unique_id_fr'";
$run145 = mysqli_query($connection,$SQL145);
$data145 = mysqli_fetch_assoc($run145);
$frlocking = $data145['locking'];
