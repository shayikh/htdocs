        ...
        <tr>
            ...
            <?php } else { ?>
                ...
                <div class="float-end" style="width: 590px;border: none;">
                    ...
                    <button onclick="showMessageForwardfn(<?php echo $data3['id'] ?>, <?php echo $unique_id_fr ?>)" class="btn btn-sm btn-dark float-end mb-2" data-bs-toggle="modal" data-bs-target="#messageforwardModal"><i class="fas fa-forward"></i></button>

                    <button class="btn btn-sm btn-dark float-end mb-2"><?php $data3['seen'] == 'Seen' ? printf("<i class='fas fa-eye'></i>") : printf("<i class='fas fa-eye-slash'></i>") ?></button>
