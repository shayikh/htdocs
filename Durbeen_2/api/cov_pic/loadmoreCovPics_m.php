...
?>
    ...
    <tr>
        ...
        <td class="text-center">
            <button onclick="deleteCovPic(<?php echo $data2['id'] ?>, <?php echo $unique_id_me ?>, this)" class="btn btn-sm btn-primary" style="margin-top: 25px"><i class="fas fa-trash-alt"></i></button>
        </td>
    </tr>
