...
<tr>
    ...
    <td class="text-center text-dark">
        <button class="btn btn-sm btn-primary" onclick="forwardMessagefn(33, <?php echo $from_unique_id_fr ?>, <?php echo $unique_id_fr_chats ?>, <?php echo $message_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
    </td>
</tr>
