...
<div class="container" style="margin-top: 150px">
    <p style="font-size: 20px;" class="text-center">Latest Messages From My Friends</p><br>
    <?php
    ...
    <img class="float-start" style="border-radius: 50%; margin-top: -5px" width="40px" height="40px" src="../pro_pic/<?php echo $pro_pic_fr ?>">
