    ...
    <div class="container" style="margin-top: 168px">
        <form action="" method="post" enctype="multipart/form-data" style="margin-bottom: 200px">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="mt-4">Profile Picture( a<span style='font-size:13px;'>&#10006;</span>a size
                            )</label>
                        <input style="background-color: #808080;color: #fff" name="image_khan_bahadur"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="mt-4">Cover Photo( 1280px <span style='font-size:13px;'>&#10006;</span> 574px
                            )</label>
                        <input style="background-color: #808080;color: #fff" name="image_khan_cover"
                               class="form-control" type="file"
                               accept="image/png, image/bmp, image/gif, image/jpg, image/avif, image/jpeg, image/jfif, image/pjpeg, image/pjp, image/apng, image/svg, image/webp">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input style="background-color: #808080;color: #fff" name="email" oninput="uniqueEmail()"
                ...
                <div class="col-md-4">
                    <div class="form-group pwdbody">
                        ...
                        <input name="password" value="<?php echo $dataMe['password'] ?>" class="pwd form-control"
                               type="password" style="background-color: #808080;color: #fff">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="religion" value="<?php echo $dataAbout['religion'] ?>" class="form-control"
                               type="text">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="country" value="<?php echo $dataAbout['country'] ?>" class="form-control"
                               type="text">
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input style="background-color: #808080;color: #fff" name="date_birth"
                               value="<?php echo $dataMe['date_birth'] ?>" class="form-control" type="date">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="mt-2">Phone No</label>
                        <input name="phone_no" value="<?php echo $dataAbout['phone_no'] ?>" class="form-control"
                               type="text">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea style="background-color: #808080;color: #fff" name="bio" rows="7"
