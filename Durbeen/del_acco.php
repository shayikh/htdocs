...
<div class="container" style="margin-top: 170px">
    <div class="row">
        ...
        <div class="col-md-12 mt-2">
            <h4 class="text-capitalize" style="line-height: 1.5;">deleting account once will permanently delete all data from database and you will never able to
            regain those data, even <span style="font-weight: 500;font-family: mahfuj;" class="text-red">দূরবীন</span> can not able to repair this. be careful before you continue.</h4>
