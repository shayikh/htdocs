    ...
    <div class="container" style="margin-top:180px">
        ...
        <script>
            ...
            function showdata() {
                ...
                axios.post("./api/facelist/loadmoreOtherComments.php",
                    postData,
                    {
                        headers: {
            ...
            const makeCommentTr = (comment) => {
                let tr = `<tr>
                            ...
                            <td class="text-center text-dark bg-danger" style="min-width: 150px">
                                <a style="color: #fff" href="./people_timeline.php?type&unique_id_fr=${comment.comn_giver_id}" target="_blank">${comment.name}</a>
                            </td>
                            <td class="text-center bg-secondary" style="min-width: 180px">${comment.time}</td>
                            <td class="text-center bg-success" style="min-width: 200px">${comment.comment}</td>
