    ...
    <tr>
        <td class="text-center">
            <a href="./people_timeline.php?type&unique_id_fr=<?php echo $unique_id_fr ?>">
                <img style="margin-top: 2px"width="110px" src="../pro_pic/<?php echo $data1['pro_pic'] ?>" alt="">
            </a>
        </td>
        <td class="text-center">
        ...
        <td class="text-center">
            <button onclick="followfn(<?php echo $unique_id_me ?>, <?php echo $unique_id_fr ?>, this)" class="btn btn-sm <?php $countF == 0 ? printf("btn-success") : printf("btn-danger") ?>" id="followBtn" style="margin-top: 15px">
