...
while ($data2 = mysqli_fetch_assoc($run2)){
    ...
    <tr>
        <td class="text-center">
            <a href="./people_timeline.php?type=no&unique_id_fr=<?php echo $data3['unique_id']?>">
                <img height="135px" title="Click to See <?php echo $data3['name'] ?>'s Timeline" width="120px" src="./pro_pic/<?php echo $data3['pro_pic'] ?>" alt="">
            </a>
        </td>
        <td class="text-center">
            <a class="text-decoration-none" href="./people_timeline.php?type=no&unique_id_fr=<?php echo $data3['unique_id']?>">
