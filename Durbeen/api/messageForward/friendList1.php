...
while ($data1=mysqli_fetch_assoc($run)){
    ...
    <tr>
        ...
        <td class="text-center text-dark">
            <button class="btn btn-sm btn-primary" onclick="forwardMessagefn(13, <?php echo $from_unique_id_me ?>, <?php echo $to_unique_id_fr ?>, <?php echo $message_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
        </td>
    </tr>
