...
$from_unique_id_me = $data['from_unique_id_me'];
...
<tr>
    ...
    <td class="text-center text-dark">
        <button class="btn btn-sm btn-primary" onclick="forwardMessagefn(13, <?php echo $from_unique_id_me ?>, <?php echo $unique_id_fr_chats ?>, <?php echo $message_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
    </td>
</tr>
...
<tr>
    ...
    <td class="text-center text-dark">
        <button class="btn btn-sm btn-primary" onclick="forwardMessagefn(11, <?php echo $from_unique_id_me ?>, <?php echo $unique_id_me ?>, <?php echo $message_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
    </td>
</tr>
...
<tr>
    ...
    <td class="text-center text-dark">
        <button class="btn btn-sm btn-primary" onclick="forwardMessagefn(12, <?php echo $from_unique_id_me ?>, <?php echo $grp_id ?>, <?php echo $message_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
    </td>
</tr>
