...
<tr>
    ...
    <td class="text-center text-dark">
        <button class="btn btn-sm btn-primary" onclick="forwardMefn(<?php echo $unique_id_me ?>, <?php echo $post_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
    </td>
</tr>
...
while ($data12 = mysqli_fetch_assoc($run12)){
    ...
    <tr>
        ...
        <td class="text-center text-dark">
            <button class="btn btn-sm btn-primary" onclick="forwardGrpfn(<?php echo $grp_id ?>, <?php echo $post_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
        </td>
    </tr>
...
while ($data1=mysqli_fetch_assoc($run)){
    ...
    <tr>
        <td class="text-center">
            <a href="./people_timeline.php?type&unique_id_fr=<?php echo $data2['unique_id'] ?>" target="_blank">
                <img class="text-center rounded-circle" width="50px" height="50px" src="../pro_pic/<?php echo $data2['pro_pic'] ?>">
            </a>
        </td>

        <td class="text-center text-dark">
            <a style="color: blue" href="./people_timeline.php?type&unique_id_fr=<?php echo $data2['unique_id'] ?>" target="_blank"><?php echo $data2['name'] ?></a>
        </td>

        <td class="text-center text-dark">
            <button class="btn btn-sm btn-primary" onclick="forwardfn(<?php echo $data2['unique_id'] ?>, <?php echo $post_id ?>, <?php echo $unique_id_me ?>, this)">Forward</button>
        </td>
    </tr>
