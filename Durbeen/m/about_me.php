...
<div class="container" style="margin-top: 99px;margin-bottom: 100px">
    <div class="row">
        ...
        <div class="col-md-12">
            <img width="335px" src="../pro_pic/cov_pic/<?php echo $cov_pic ?>" id="cov_pic">
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered mt-3" style="border-color: #5d5d5d">
                ...
                <tr>
                    ...
                    <td>
                        <h6 class="one d-none">
                            http://durbeen.unaux.com/people_timeline.php?type&unique_id_fr=<?php echo $dataMe['unique_id'] ?></h6>
        ...
        <div class="col-md-12 mt-5 pt-5">
            <h4 class="red text-white text-center py-5">DANGER ZONE &#8595;</h4>
        </div>
        <div class="col-md-3"></div>

        <div class="col-md-6 mt-4">
            <a href="./del_acco.php?type" class="btn btn-sm btn-dark form-control">&#9762; ACCOUNT DELETION &#9785;</a>
        </div>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-success" onclick="showMyComment()">
                    More Comments
                </button>
...
<div class="modal fade" id="otherCommentModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" modal-dialog modal-dialog-scrollable>
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-success" onclick="showOtherComment()">
                    More Comments
                </button>
                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">
                    Close
