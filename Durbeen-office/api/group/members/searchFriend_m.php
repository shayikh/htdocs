...
while($data154 = mysqli_fetch_assoc($run1)) {
    ...
    $SQLF154 = "SELECT * FROM `registration` WHERE `unique_id`='$unique_id_fr' AND `unique_id`!='$unique_id_me'";
    ...
    if ($result) {
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <h6 style="margin-top: 5px"><?php $countF155 > 0 ? printf("Admin") : printf("Member") ?></h6>
            </td>
        </tr>
